...
class QuestionGroupSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = QuestionGroup
        fields = ['id', 'title', 'instructions', 'content', 'group_type', 'container', 'options', 'image', 'media_file', 'audio_start_time', 'order', 'questions']
...
class AdminQuestionGroupSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = QuestionGroup
        fields = ['id', 'module', 'title', 'instructions', 'content', 'group_type', 'container', 'options', 'image', 'media_file', 'audio_start_time', 'order', 'questions']
